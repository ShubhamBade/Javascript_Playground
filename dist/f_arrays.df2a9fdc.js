...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"topics/f_arrays.js":[function(require,module,exports) {
...
arr1[1] = "Coconunt";
console.log(arr1);
var arr2 = new Array("Orange", "Apple");
console.log(arr2);
...
var arr7 = arr6.map(function (item) {
  return item * 10;
});
console.log(arr7);

//The flatMap() method first maps all elements of an array and then creates a new array by flattening the array.
console.log(arr7.flatMap(function (item) {
  return item * 10;
}));

// filter method - return a new array with array element that pass the test or condition
var arr8 = arr7.filter(function (value) {
  return value < 500;
});
console.log(arr8);

// reduce function - return a single value by performinng opertion
console.log(arr7.reduce(function (total, value) {
  return total + value;
}), arr7); // total-previous count and value-new element from array

// The every() method checks if all array values pass a test.
console.log(arr7.every(function (value) {
  return value >= 20;
})); // true or false

//The some() method checks if some array values pass a test.
console.log(arr7.some(function (value) {
  return value > 400;
})); // true or false
...
console.log(arr7.find(function (value) {
  return value > 40;
}));

//The findIndex() method returns the index of the first array element that passes a test function.
console.log(arr7.findIndex(function (value) {
  return value > 400;
}));
...
console.log([].concat(arr6, _toConsumableArray(arr7))); // concating using spread operator
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","topics/f_arrays.js"], null)
//# sourceMappingURL=/f_arrays.df2a9fdc.js.map